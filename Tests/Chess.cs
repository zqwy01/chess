...
namespace Tests
{
    public class Chess
    {
        ...
        //Загрузка координат
        public bool coords_making(int KX, int KY, int RX, int RY, int EX, int EY)
        {
        ...
        public bool checking_borders(int KX, int KY, int RX, int RY, int EX, int EY)
        {
        ...
        public bool checking_same_coords(int KX, int KY, int RX, int RY, int EX, int EY)
        {
        ...
        public bool checking_alarm_elephant(int KX, int KY, int RX, int RY, int EX, int EY)
        {
        ...
        public bool checking_alarm_rook(int KX, int KY, int RX, int RY, int EX, int EY)
        {
            if ((KX == RX) || (KY == RY))
            {
                return true;
